...
- `condition` is initially parsed from `experiment` in FragPipe, but users could change later.
...
4. Use the file chooser to upload the quantification table and the `experiment_annotation.tsv` file
5. If you are using LFQ or LFQ (peptide), choose the intensity type: **Intensity**, **MaxLFQ Intensity**, or **Spectral Count**
6. Optionally expand **Advanced Options** to configure normalization, imputation, FDR correction, and DE thresholds
